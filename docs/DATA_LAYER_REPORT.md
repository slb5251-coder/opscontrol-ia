...
Funções top-level encontradas: **311**
Funções candidatas: **149**

## renderMobileShell

- Linhas: 142-239
- Chamadas internas: canManageChemicals, canManageClientTickets, canManageFluidCatalog, canManageVesselRegistry, hasRole, isStandaloneApp, mobileModuleButton, mobileQuickButton, moduleAllowed, offlineQueue
- Dependências globais principais: state
...
- Linhas: 258-285
- Chamadas internas: clientTicketDocuments
- Dependências globais principais: state
...
- Linhas: 328-366
- Chamadas internas: canManageChemicals, chemicalProductForm, clientTicketDetails, closeModal, hasRole, maintenanceOrderForm, openAssetQr, openModal, operationForm, showPage, toast
- Dependências globais principais: state
...
- Linhas: 696-716
- Chamadas internas: isAdmin, role
- Dependências globais principais: state
...
- Linhas: 851-862
- Chamadas internas: nenhuma
- Dependências globais principais: nenhuma
...
- Linhas: 917-950
- Chamadas internas: saveEntity, saveTruck
- Dependências globais principais: state
...
- Linhas: 952-969
- Chamadas internas: loadData, offlineQueue, renderAll, replayOfflineAction, saveOfflineQueue, toast
- Dependências globais principais: state
...
- Linhas: 988-996
- Chamadas internas: backupPayload
- Dependências globais principais: state
...
- Linhas: 1003-1048
- Chamadas internas: auditChangeSummary, chemicalDisplayStatus, clientTicketDocuments, clientTicketMetrics, dataQualityIssues, downloadCsv, filteredClientTickets, filteredOperations, filteredTrucks, filteredVessels, groupedChemicalInventory, operationAllocationText, trucksForPage
- Dependências globais principais: state
...
## syncOperationCatalogFields

- Linhas: 1082-1106
- Chamadas internas: operationAllocationRow, operationFieldValue, selectedOperationCatalogItem, syncOperationTankFields, tankMovementMode
- Dependências globais principais: nenhuma
...
## normalizedOperationAllocations

- Linhas: 1115-1126
- Chamadas internas: allocationsForOperation, tankMovementMode
- Dependências globais principais: nenhuma
...
- Linhas: 1128-1135
- Chamadas internas: normalizedOperationAllocations
- Dependências globais principais: state
...
## refreshOperationAllocationOptions

- Linhas: 1188-1203
- Chamadas internas: operationFieldValue, operationTankOptions, tankMovementMode
- Dependências globais principais: nenhuma
...
## collectOperationAllocations

- Linhas: 1217-1249
- Chamadas internas: operationFieldValue, parseTankVolume, tankMovementMode
- Dependências globais principais: state
...
## syncOperationTankFields

- Linhas: 1267-1305
- Chamadas internas: operationAllocationRow, operationFieldValue, refreshOperationAllocationOptions, tankMovementMode, updateOperationAllocationSummary
- Dependências globais principais: nenhuma
...
- Linhas: 1368-1761
- Chamadas internas: applySiloCapacityModels
- Dependências globais principais: state
...
- Linhas: 1840-1872
- Chamadas internas: applyTheme, decorateSidebarNavigation, moduleAllowed, openAppProfileHeader, renderAll, renderMobileShell, role, saveLocalDailyBackup, setupMobilePullToRefresh, showPage, startAutoRefresh, subscribeRealtime, syncOfflineQueue, updateConnectionBadge
- Dependências globais principais: state
...
- Linhas: 1910-1913
- Chamadas internas: refreshRealtime
- Dependências globais principais: state
...
- Linhas: 1940-1965
- Chamadas internas: loadData, renderAll, toast, updateConnectionBadge
- Dependências globais principais: state
...
- Linhas: 1982-2010
- Chamadas internas: renderMobileShell, renderModuleSafely
- Dependências globais principais: state
...
- Linhas: 2114-2137
- Chamadas internas: tvPhaseAssets
- Dependências globais principais: state
...
- Linhas: 2139-2152
- Chamadas internas: tvActiveOperations
- Dependências globais principais: state
...
- Linhas: 2154-2178
- Chamadas internas: isSiloAsset, tvActiveOperations, tvCriticalAlerts
- Dependências globais principais: state
...
- Linhas: 2180-2195
- Chamadas internas: badge, tvCriticalAlerts
- Dependências globais principais: state
...
- Linhas: 2229-2251
- Chamadas internas: tvPlantSlide, updateTvClock
- Dependências globais principais: state
...
## renderFigmaDashboard

- Linhas: 2366-2475
- Chamadas internas: badge, filteredOperations, filteredTrucks, header, productClass
- Dependências globais principais: state
...
- Linhas: 2477-2708
- Chamadas internas: aggregateOperationVolume, badge, dashboardRoleHome, filterIsActive, filteredOperations, filteredTrucks, header, operationFlow, productClass, statCard, storageCard
- Dependências globais principais: state
...
- Linhas: 2711-2780
- Chamadas internas: isSiloAsset, normalizedOperationAllocations, tankMovementMode
- Dependências globais principais: state
...
- Linhas: 2782-2803
- Chamadas internas: normalizedOperationAllocations, tankMovementMode
- Dependências globais principais: state
...
- Linhas: 2867-2887
- Chamadas internas: canManageVesselRegistry
- Dependências globais principais: state
...
- Linhas: 2889-2904
- Chamadas internas: badge, canDeleteVesselRegistry, canManageVesselRegistry, header, marineTrafficVesselButton
- Dependências globais principais: state
...
- Linhas: 2923-2934
- Chamadas internas: badge, marineTrafficOperationButton, planningAssessment
- Dependências globais principais: state
...
- Linhas: 3064-3078
- Chamadas internas: updateOperationReview
- Dependências globais principais: state
...
- Linhas: 3092-3142
- Chamadas internas: canManageVesselRegistry, hasRole, isAdmin, normalizedOperationAllocations, operationAllocationRow, operationCatalogOptions, tankMovementMode
- Dependências globais principais: state
...
## scheduleVesselMapInit

- Linhas: 3242-3248
- Chamadas internas: initVesselMap
- Dependências globais principais: state
...
- Linhas: 3274-3332
- Chamadas internas: filteredVessels, vesselDistanceNm, vesselGeofence, vesselLatestPosition, vesselMapFallback, vesselSignalInfo
- Dependências globais principais: state
...
function initVesselMap() {
    ...
    window.L.circle([zone.latitude, zone.longitude], {
      radius: Number(zone.radiusNm || 25) * 1852,
      weight: 2,
      fillOpacity: 0.08
    }).addTo(map).bindTooltip(`${zone.name} • raio ${fmt.format(zone.radiusNm)} mn`);
    window.L.circleMarker([zone.latitude, zone.longitude], { radius: 7, weight: 3, fillOpacity: 1 })
    ...
    all.forEach(item => {
      ...
      const markerIcon = window.L.divIcon({
        className: "vessel-map-marker-wrap",
        html: `<span class="vessel-map-marker tone-${signal.tone}" style="transform:rotate(${heading}deg)">▲</span>`,
        iconSize: [28, 28], iconAnchor: [14, 14]
      });
      const marker = window.L.marker([position.latitude, position.longitude], { icon: markerIcon })
        .addTo(map)
        .bindPopup(`<strong>${esc(item.vesselName)}</strong><br>${esc(item.client)}<br>${position.speedKnots === null ? "Velocidade indisponível" : `${fmt.format(position.speedKnots)} kn`}${distance === null ? "" : `<br>${fmt.format(distance)} mn do Porto do Açu`}<br><small>${esc(signal.label)}</small>`);
      marker.on("click", () => { state.vesselMap.selected = item.id; });
      state.vesselMap.markers.set(item.id, marker);
      bounds.extend([position.latitude, position.longitude]);
    });
    if ((state.data.vesselPositions || []).length) map.fitBounds(bounds.pad(0.25), { maxZoom: 11 });
...
- Linhas: 3334-3343
- Chamadas internas: canManageVessels
- Dependências globais principais: state

```js
async function syncVesselAis(scheduleId = null) {
    if (!canManageVessels()) throw new Error("Seu perfil não pode sincronizar o AIS.");
    const { data, error } = await state.client.functions.invoke("sync-vessel-ais", { body: scheduleId ? { schedule_id: scheduleId } : {} });
    if (error) {
      let detail = error.message || "Falha ao sincronizar AIS.";
      try { const body = await error.context?.json(); if (body?.message || body?.error) detail = body.message || body.error; } catch (_) {}
...
- Linhas: 3359-3395
- Chamadas internas: canManageVessels, haversineNm, vesselGeofence
- Dependências globais principais: state
...
```js
async function resolveVesselAlert(alertId) {
    const { error } = await state.client.from("vessel_ais_alerts").update({ resolved_at: new Date().toISOString(), resolved_by: state.user.id }).eq("id", alertId);
    if (error) throw error;
  }
```

## marineTrafficOperationButton

- Linhas: 3422-3429
- Chamadas internas: marineTrafficVesselButton
- Dependências globais principais: state
...
- Linhas: 3431-3504
- Chamadas internas: badge, canDeleteVessels, canManageVessels, filteredVessels, header, marineTrafficVesselButton, scheduleVesselMapInit, statCard, vesselAlertTone, vesselDistanceNm, vesselEtaInfo, vesselGeofence, vesselLatestPosition, vesselPositionSummary, vesselSignalInfo
- Dependências globais principais: state
...
function renderVessels() {
    ...
    const scheduledWeek = all.filter(item => item.eta && new Date(item.eta).getTime() >= now && new Date(item.eta).getTime() <= weekEnd && !["Concluída", "Cancelada"].includes(item.status)).length;
    const atPort = all.filter(item => ["Atracada", "Em operação"].includes(item.status)).length;
    const arriving24 = all.filter(item => {
      if (!item.eta || ["Atracada", "Em operação", "Concluída", "Cancelada"].includes(item.status)) return false;
      const diff = new Date(item.eta).getTime() - now;
      return diff >= 0 && diff <= 86400000;
    }).length;
    const openAlerts = (state.data.vesselAisAlerts || []).filter(item => !item.resolvedAt);
    const attention = Math.max(all.filter(item => vesselEtaInfo(item).tone === "red").length, openAlerts.filter(item => ["Alta","Crítica"].includes(item.severity)).length);
    ...
    const cards = rows.map(item => {
      ...
      const position = vesselLatestPosition(item.id);
      const distance = vesselDistanceNm(item, position);
      return `<article class="vessel-schedule-card tone-${etaInfo.tone}">
    ...
    const positionRows = (state.data.vesselPositions || []).filter(position => visibleVesselIds.has(position.scheduleId)).slice(0, 8).map(position => {
      ...
      return `<button class="vessel-position-row" data-focus-vessel="${position.scheduleId}"><span class="vessel-position-dot tone-${signal.tone}"></span><div><strong>${esc(vessel?.vesselName || "Embarcação")}</strong><small>${fmt.format(position.latitude)}, ${fmt.format(position.longitude)} • ${position.speedKnots === null ? "velocidade indisponível" : `${fmt.format(position.speedKnots)} kn`}${distance === null ? "" : ` • ${fmt.format(distance)} mn`}</small></div><time>${dateTime(position.positionTime)}</time></button>`;
    }).join("");

    const alertRows = openAlerts.slice(0, 6).map(alert => {
      const vessel = all.find(item => item.id === alert.scheduleId);
...
## normalizeSiloProduct

- Linhas: 3618-3625
- Chamadas internas: normalizeTankName
- Dependências globais principais: nenhuma
...
- Linhas: 3634-3671
- Chamadas internas: hasRole, header
- Dependências globais principais: state
...
- Linhas: 3688-3747
- Chamadas internas: badge, defaultSiloPhysicalCapacity, hasRole, isAdmin, isSiloAsset, productClass
- Dependências globais principais: state
...
function completeTankTimeline(tank) {
    ...
    state.data.tankHistory.filter(item=>item.tank_id===tank.id).forEach(item=>{
      ...
      const clientChange = item.previous_client !== item.new_client && (item.previous_client || item.new_client)
        ? ` • Cliente ${item.previous_client || "A definir"} → ${item.new_client || "A definir"}` : "";
      entries.push({time:item.created_at,title:`Atualização: ${item.previous_product||"Vazio"} → ${item.new_product||"Vazio"}`,meta:`${user} • saldo ${fmt.format(item.previous_volume||0)} → ${fmt.format(item.new_volume||0)} ${tank.unit}`,detail:(item.notes||`Lote ${item.previous_lot||"-"} → ${item.new_lot||"-"}`)+clientChange});
    });
...
## completeTankTimelineHtml

- Linhas: 3783-3786
- Chamadas internas: completeTankTimeline, tankHistoryVisual
- Dependências globais principais: state
...
- Linhas: 3800-3818
- Chamadas internas: defaultSiloPhysicalCapacity, isSiloAsset, parseTankVolume, siloOperationalCapacity
- Dependências globais principais: state
...
## syncSiloCapacityPreview

- Linhas: 3882-3941
- Chamadas internas: isSiloAsset, parseOptionalDecimal, siloCapacityForProduct, siloOperationalCapacity
- Dependências globais principais: state
...
## syncTankCatalogFields

- Linhas: 3943-3963
- Chamadas internas: defaultDensityUnit, syncSiloCapacityPreview
- Dependências globais principais: nenhuma
...
## syncFluidDensityUnit

- Linhas: 3965-3970
- Chamadas internas: defaultDensityUnit
- Dependências globais principais: nenhuma
...
- Linhas: 3982-4114
- Chamadas internas: activeCompatibleTankProducts, catalogProductOptions, defaultDensityUnit, defaultSiloPhysicalCapacity, isAdmin, isSiloAsset, siloCapacityForProduct, siloOperationalCapacity, tankClientSuggestions
- Dependências globais principais: state
...
## toggleFluidCatalogActive

- Linhas: 4117-4148
- Chamadas internas: addTestLog, canManageFluidCatalog, defaultDensityUnit, loadData, renderFluids, renderMobileShell, renderTanks, toast
- Dependências globais principais: state
...
- Linhas: 4170-4204
- Chamadas internas: canManageFluidCatalog, header
- Dependências globais principais: state
...
- Linhas: 4219-4234
- Chamadas internas: badge, canManageChemicals, groupedChemicalInventory, header
- Dependências globais principais: state
...
- Linhas: 4301-4372
- Chamadas internas: badge, canManageChemicals, chemicalDisplayStatus, groupedChemicalInventory, header, statCard
- Dependências globais principais: state
...
## duplicateTruckInvoiceIds

- Linhas: 4423-4432
- Chamadas internas: normalizedTruckInvoice
- Dependências globais principais: state
...
- Linhas: 4478-4499
- Chamadas internas: duplicateTruckInvoiceIds, normalizeTruckFilterValue, truckAttentionMatches, truckProductNames, truckSearchText
- Dependências globais principais: state
...
- Linhas: 4521-4636
- Chamadas internas: attachmentCount, badge, canManageTrucks, duplicateTruckInvoiceIds, header, statCard, truckAttentionFlags, truckAttentionHtml, truckFilterActiveCount, truckInventoryLabel, truckItemsSummary, truckOpenAgeDays, truckRankingHtml, trucksForPage
- Dependências globais principais: state
...
- Linhas: 4656-4670
- Chamadas internas: clientTicketMetrics
- Dependências globais principais: state
...
- Linhas: 4707-4740
- Chamadas internas: badge, canManageClientTickets, clientTicketDocumentChip, clientTicketFilterActiveCount, clientTicketMetrics, clientTicketStatusTone, filteredClientTickets, header, statCard
- Dependências globais principais: state
...
## clientTicketDocumentUploadForm

- Linhas: 4761-4773
- Chamadas internas: clientTicketMetrics, formActions
- Dependências globais principais: nenhuma
...
- Linhas: 4787-4800
- Chamadas internas: badge, canDeleteClientTickets, canManageClientTickets, clientTicketDocumentChip, clientTicketDocumentUploadForm, clientTicketDocuments, clientTicketMetrics
- Dependências globais principais: state
...
- Linhas: 4802-4819
- Chamadas internas: canManageClientTickets
- Dependências globais principais: state
...
## uploadClientTicketDocument

- Linhas: 4821-4849
- Chamadas internas: canManageClientTickets, clientTicketDocuments, safeFileName
- Dependências globais principais: state
...
## openClientTicketDocument

- Linhas: 4851-4857
- Chamadas internas: toast
- Dependências globais principais: state
...
- Linhas: 4859-4885
- Chamadas internas: attachmentCount, badge, hasRole, header, isAdmin, statCard
- Dependências globais principais: state
...
- Linhas: 4916-4944
- Chamadas internas: attachmentCount, badge, canManageCertificates, header, statCard, statusClass
- Dependências globais principais: state
...
- Linhas: 4946-4970
- Chamadas internas: badge, hasRole, header, isAdmin, moduleAllowed, offlineQueue, role, statCard, statusClass
- Dependências globais principais: state
...
## ensureHandoverSelection

- Linhas: 4979-4984
- Chamadas internas: defaultHandoverSelection
- Dependências globais principais: state
...
- Linhas: 5005-5050
- Chamadas internas: ensureHandoverSelection, shiftWindow, timestampInWindow
- Dependências globais principais: state
...
## selectedHandoverApproval

- Linhas: 5063-5065
- Chamadas internas: ensureHandoverSelection
- Dependências globais principais: state
...
- Linhas: 5072-5077
- Chamadas internas: canApproveHandover, canManageHandover, hasRole, selectedHandoverApproval
- Dependências globais principais: state
...
- Linhas: 5118-5183
- Chamadas internas: checklistForShift, handoverSection, selectedHandoverApproval
- Dependências globais principais: state
...
- Linhas: 5225-5234
- Chamadas internas: currentClosing, formActions
- Dependências globais principais: state
...
- Linhas: 5246-5253
- Chamadas internas: badge, hasRole
- Dependências globais principais: state
...
- Linhas: 5255-5259
- Chamadas internas: badge, closingDetails, hasRole
- Dependências globais principais: state
...
- Linhas: 5270-5292
- Chamadas internas: badge, canDeleteHandoverPending, canManageHandover, ensureHandoverSelection, handoverApprovalCard, handoverSheetHtml, handoverSnapshot, hasRole, header, metricComparison, offlineQueue, periodStats, renderClosingPanel, selectedHandoverApproval, shiftChecklistHtml, statCard
- Dependências globais principais: state
...
- Linhas: 5301-5320
- Chamadas internas: auditChangeSummary, badge, canViewAudit, header, statCard
- Dependências globais principais: state
...
- Linhas: 5349-5377
- Chamadas internas: badge, environmentPanel, feedbackManagementPanel, hasRole, header, homologationPanel, isAdmin, latestLocalBackup, offlineQueue, statCard
- Dependências globais principais: state
...
function renderSettings() {
    ...
    const adminUsers = users.filter(user => /admin/i.test(user.role || "")).length;
    const leadershipUsers = users.filter(user => /supervisor|lider|líder/i.test(user.role || "")).length;
    const departmentCounts = users.reduce((acc,user)=>{const key=user.department||"Não informado";acc[key]=(acc[key]||0)+1;return acc;},{});
    const departmentRows = Object.entries(departmentCounts).sort((a,b)=>b[1]-a[1]).slice(0,6).map(([name,count])=>`<div class="settings-department-row"><span>${esc(name)}</span><div><i style="width:${users.length?Math.max(8,Math.round(count/users.length*100)):0}%"></i></div><strong>${count}</strong></div>`).join("");
    ...
    const mobileUsers = users.map(user => `<article class="card mobile-record-card settings-user-mobile"><div class="mobile-record-head"><div><strong>${esc(user.name)}</strong><small>${esc(user.email)}</small></div>${badge(user.active ? "Ativo" : "Inativo")}</div><div class="mobile-record-grid"><span>Cargo<strong>${esc(user.role)}</strong></span><span>Setor<strong>${esc(user.department || "-")}</strong></span><span>Cadastro<strong>${dateOnly(user.created_at)}</strong></span></div>${isAdmin() ? `<button class="btn primary full" data-edit-user="${user.id}">Gerenciar usuário</button>` : ""}</article>`).join("");
    ...
    const backupDate = latestLocalBackup()?.created_at ? dateTime(latestLocalBackup().created_at) : "-";
    const environment = state.config.environment === "production" ? "Produção" : "Homologação";
    const healthItems = [
      ["Banco de dados", state.client ? "Conectado" : "Não conectado", state.client ? "ok" : "warning"],
      ["Sincronização", lastSync, state.lastSync ? "ok" : "warning"],
      ["Fila offline", `${queueCount} pendência(s)`, queueCount ? "warning" : "ok"],
      ["Erros registrados", `${errors.length} ocorrência(s)`, errors.length ? "danger" : "ok"],
...
## truckPlatformItemRow

- Linhas: 5491-5500
- Chamadas internas: platformProductOptions
- Dependências globais principais: state
...
## syncTruckSingleProduct

- Linhas: 5512-5529
- Chamadas internas: truckCatalogOptions, truckCatalogProducts, truckTankOptions
- Dependências globais principais: state
...
- Linhas: 5538-5557
- Chamadas internas: syncTruckSingleProduct, truckPlatformItemRow, updateTruckPlatformSummary
- Dependências globais principais: nenhuma
...
## collectTruckPlatformItems

- Linhas: 5559-5574
- Chamadas internas: parseTankVolume
- Dependências globais principais: state
...
- Linhas: 5584-5621
- Chamadas internas: formActions, inferredTruckType, truckCatalogOptions, truckTankOptions
- Dependências globais principais: state
...
- Linhas: 5658-5726
- Chamadas internas: defaultDensityUnit, formActions
- Dependências globais principais: state
...
- Linhas: 5780-5798
- Chamadas internas: safeFileName
- Dependências globais principais: state
...
- Linhas: 5800-5823
- Chamadas internas: fileSizeLabel, isAdmin, openModal
- Dependências globais principais: state
...
## refreshTankProductList

- Linhas: 5869-5896
- Chamadas internas: loadData, syncTankCatalogFields, tankForm, toast
- Dependências globais principais: state
...
async function refreshTankProductList(form) {
    ...
    const currentClient = form.elements.client?.value || "A definir";
    ...
    if (refreshed?.elements.client) refreshed.elements.client.value = currentClient;
...
- Linhas: 5898-6122
- Chamadas internas: closeModal, defaultSiloPhysicalCapacity, friendlyTankSaveError, isAdmin, isSiloAsset, loadData, parseOptionalDecimal, parseTankVolume, renderDashboard, renderTanks, siloCapacityForProduct, siloOperationalCapacity, toast
- Dependências globais principais: state
...
async function saveTankVolume(form, button = null) {
    ...
    const newClient = String(payload.client || "").trim();
    ...
    if (!newClient) throw new Error("Informe o cliente do tanque ou silo.");
    if (newClient.length > 100) throw new Error("O nome do cliente deve ter no máximo 100 caracteres.");
    ...
    try {
      ...
      const rpcName = adminFull ? "admin_update_tank_with_client_v1" : "update_tank_content_v10";
      ...
      if (String(serverRow.client || "A definir").trim() !== newClient) {
...
- Linhas: 6124-6201
- Chamadas internas: parseTankVolume, tankMovementMode
- Dependências globais principais: state
...
- Linhas: 6203-6260
- Chamadas internas: defaultDensityUnit, parseOptionalDecimal
- Dependências globais principais: state
...
- Linhas: 6321-6362
- Chamadas internas: isMobileViewport, refreshRealtime
- Dependências globais principais: state
...
- Linhas: 6369-6434
- Chamadas internas: productClass
- Dependências globais principais: state
...
function smartAnswer(question) {
    ...
    return "Posso responder sobre Brine, WBM, SBM, Barita, embarcações, ETA, inventário químico, carretas, diesel, certificados e tanques bloqueados.";
  }
```
